...
+------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+
| Nähe einer Replikationsstudie zur Originalstudie (in Anlehnung an LeBel et al. [2019] und Hüffmeier  | **Direkte Replikation**\                                                      |
| et al. [2016])                                                                                       |                                                                               |
...
![Wald-Diagramm (Forest Plot) mit simulierten Korrelationen aus 15 fiktiven Studien.](images/pdf-figuren/bestandsaufnahme-forestplot.png){#fig-forestplot width="100%"}
