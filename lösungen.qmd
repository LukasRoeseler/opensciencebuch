...
![Lösungsansätze und welches Problem in der Wissenschaft sie aufgreifen.](images/lösungsansätze.png){#fig-lösungsansätze width="100%"}
:::

::: {.content-visible when-format="pdf"}
![Lösungsansätze und welches Problem in der Wissenschaft sie aufgreifen.](images/lösungsansätze.png){#fig-lösungsansätze height="15cm"}
:::
