...
In English, "science" refers only to the natural sciences, which means that, strictly speaking, "Open Science" excludes the humanities. While in English all fields are therefore often addressed jointly as "Science and Humanities," when it comes to Open Science the term "[Open Scholarship](https://forrt.org/glossary/german/open_scholarship/)" is often used instead [@Parsons.2022].
:::
