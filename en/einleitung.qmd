...
How the openness of science is changing, what researchers around the world are doing to open up science, and what proposed solutions are being discussed and implemented in this regard is the subject of this book. An overview of the dimensions of openness, based on @Silveira2023-xq, is given in the table below. Many scientific disciplines lie somewhere between the extremes of "classical science" and "open science." The latter represents the ideal -- that is, the state that would be most beneficial for scientific progress.
...
| Open evaluation of researchers, universities, and journals | Science is evaluated on the basis of opaque and manipulable metrics. | Science is evaluated on the basis of objective criteria closely tied to scientific quality assurance. |
