...
In einigen Bereichen hat sich Open Science von etwas Positivem, das nicht vermisst wurde, wenn es gefehlt hat, zu etwas selbstverständlichen entwickelt. Im Diskurs wird gelegentlich vom Open Science-[Kano-Modell](https://de.wikipedia.org/wiki/Kano-Modell) gesprochen. Während das nicht für alle Facetten von Open Science gilt (z.B. nicht für Citizen Science), ist eine Sache klar: Um einen (schnellen) Wissenszuwachs zu ermöglichen, muss das Wissen prüfbar sein. Das geht nur mit offenen Forschungsberichten (Open Access), offenen Daten (Open Data), und nachprüfbaren Berechnungen (Open Code, Reproducibility).
